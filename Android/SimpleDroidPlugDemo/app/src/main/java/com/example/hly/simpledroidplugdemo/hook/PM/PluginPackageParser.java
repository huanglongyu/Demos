...
package com.example.hly.simpledroidplugdemo.hook.PM;
...
import com.example.hly.simpledroidplugdemo.hook.ComponentNameComparator;
import com.example.hly.simpledroidplugdemo.hook.DirHelper;
import com.example.hly.simpledroidplugdemo.hook.utils.FieldUtils;
...
public class PluginPackageParser {
    ...
    private ApplicationInfo fixApplicationInfo(ApplicationInfo applicationInfo) {
        ...
        if (applicationInfo.dataDir == null) {
            applicationInfo.dataDir = DirHelper.getPluginDataDir(mHostContext, applicationInfo.packageName);
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            if (applicationInfo.nativeLibraryDir == null) {
                applicationInfo.nativeLibraryDir = DirHelper.getPluginNativeLibraryDir(mHostContext, applicationInfo.packageName);
            }
        }
