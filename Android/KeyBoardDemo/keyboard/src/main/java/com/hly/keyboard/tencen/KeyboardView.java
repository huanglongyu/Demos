...
//        View inflate = LayoutInflater.from(context).inflate(this.mContext.getResources().getIdentifier("tenpay_number_keyboard", "layout", this.mContext.getPackageName()), this, true);
        View inflate = LayoutInflater.from(context).inflate(R.layout.tenpay_number_keyboard, this, true);
        this.mKey1 = (Button) inflate.findViewById(R.id.tenpay_keyboard_1);
        this.mKey2 = (Button) inflate.findViewById(R.id.tenpay_keyboard_2);
        this.mKey3 = (Button) inflate.findViewById(R.id.tenpay_keyboard_3);
        this.mKey4 = (Button) inflate.findViewById(R.id.tenpay_keyboard_4);
        this.mKey5 = (Button) inflate.findViewById(R.id.tenpay_keyboard_5);
        this.mKey6 = (Button) inflate.findViewById(R.id.tenpay_keyboard_6);
        this.mKey7 = (Button) inflate.findViewById(R.id.tenpay_keyboard_7);
        this.mKey8 = (Button) inflate.findViewById(R.id.tenpay_keyboard_8);
        this.mKey9 = (Button) inflate.findViewById(R.id.tenpay_keyboard_9);
        this.mKeyX = (Button) inflate.findViewById(R.id.tenpay_keyboard_x);
        this.mKey0 = (Button) inflate.findViewById(R.id.tenpay_keyboard_0);
        this.mKeyD = (ImageButton) inflate.findViewById(R.id.tenpay_keyboard_d);
        OnClickListener anonymousClass1 = new OnClickListener() {
            public void onClick(View view) {
                if (mInputEditText != null) {
                    ...
                    int i;
                    if (view.getId() == R.id.tenpay_keyboard_1) {
                        i = 8;
                    } else if (view.getId() == R.id.tenpay_keyboard_2) {
                        i = 9;
                    } else if (view.getId() == R.id.tenpay_keyboard_3) {
                        i = 10;
                    } else if (view.getId() == R.id.tenpay_keyboard_4) {
                        i = 11;
                    } else if (view.getId() == R.id.tenpay_keyboard_5) {
                        i = 12;
                    } else if (view.getId() == R.id.tenpay_keyboard_6) {
                        i = 13;
                    } else if (view.getId() == R.id.tenpay_keyboard_7) {
                        i = 14;
                    } else if (view.getId() == R.id.tenpay_keyboard_8) {
                        i = 15;
                    } else if (view.getId() == R.id.tenpay_keyboard_9) {
                        i = 16;
                    } else if (view.getId() == R.id.tenpay_keyboard_0) {
                        i = 7;
                    } else if (view.getId() == R.id.tenpay_keyboard_d) {
                        i = 67;
                    } else {
                        i = 0;
                    }
